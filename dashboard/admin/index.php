...
$pesanan_tertunda = $db->db_From_Id("SELECT * FROM user_order WHERE konfirmasi = 0 AND tolak = 0");

// QUERY DATABASE SESUAI DENGAN STATUS PESANAN NYA TELAH DIGUNAKAN
$pesanan_selesai = $db->db_From_Id("SELECT * FROM user_order WHERE konfirmasi = 1 AND tolak = 0");

$rating_layanan = $db->db_From_Id("SELECT AVG(rating) as rating FROM user_reviews")[0]['rating'];
// var_dump($rating_layanan);
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Rating Layanan</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php echo round($rating_layanan ?? 0, 2) ?></div>
                                        </div>
                                        <div class="col-auto">
